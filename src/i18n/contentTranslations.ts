...
export const QUESTION_IT: Record<string, QuestionTranslation> = {
  ...
  p_industries: {
    ...
    options: {
      "Agriculture, Aquaculture & Agritech": "Agricoltura, acquacoltura e agritech",
      "Forestry & Paper": "Silvicoltura e carta",
      "Fishing & Hunting": "Pesca e caccia",
      "Food & Beverages": "Alimentari e bevande",
      "Mining & Metallurgy": "Estrattivo e metallurgia",
      "Materials & Chemistry": "Materiali e chimica",
      "Machinery & Electronics": "Macchinari ed elettronica",
      "Construction": "Costruzioni",
      "Manufacturing": "Manifatturiero",
      "Engineering": "Ingegneria",
      "Defence": "Difesa",
      "Infrastructure & Logistics": "Infrastrutture e logistica",
      "Transport": "Trasporti",
      "Aerospace": "Aerospaziale",
      "Automotive": "Automotive",
      "Maritime": "Marittimo",
      "Road & Rail": "Strada e ferrovia",
      "Healthcare": "Sanità",
      ...
      "Wellness": "Benessere",
      "Femtech": "Femtech",
      "Scientific Tools & Services": "Strumenti e servizi scientifici",
      ...
      "Travel & Hospitality": "Viaggi e ospitalità",
      "Marketing": "Marketing",
      "Data & Analytics": "Dati e analytics",
      "Software & Services": "Software e servizi",
      "Hardware & Electronic Equipment": "Hardware e apparecchiature elettroniche",
      "Telecommunications & Services": "Telecomunicazioni e servizi",
      "Retail": "Retail",
      "E-commerce": "E-commerce",
      "Textiles, Apparel & Luxury Goods": "Tessile, abbigliamento e beni di lusso",
      "Consumer Electronics & Appliances": "Elettronica di consumo ed elettrodomestici",
      "Home & Personal Care Products": "Prodotti per la casa e cura della persona",
      "Consumer Services": "Servizi al consumatore",
      "Human Resources & Employment": "Risorse umane e lavoro",
      "Research & Consulting": "Ricerca e consulenza",
      "Office Services": "Servizi per ufficio",
      "Public Services (excl. education)": "Servizi pubblici (escl. istruzione)",
    },
  },
  p_stage: {

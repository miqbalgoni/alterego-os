...
export const PERSONAL_QUESTIONS: Question[] = [
  ...
  { id: "p_phone",       section: "personal", label: "Phone",        type: "tel",      required: false },
  { id: "p_address",     section: "personal", label: "Address",      type: "text",     required: false },
